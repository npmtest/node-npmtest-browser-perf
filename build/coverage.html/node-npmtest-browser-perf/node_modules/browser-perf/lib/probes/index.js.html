...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-browser-perf/node_modules/browser-perf/lib/probes/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-browser-perf/node_modules/browser-perf/lib/probes/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-browser-perf/node_modules/browser-perf/lib/probes/</a> &#187; index.js</div>
</div>
<div class="body">
...
ProbeManager.prototype.addProbes = function(metric) {
	var me = this;
	metric.probes = metric.probes || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
	metric.probes.forEach(function(probe) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (typeof probe === 'string') {
&nbsp;
...
&nbsp;
		<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof probe !== 'object' || typeof probe.id === 'undefined') {
<span class="cstat-no" title="statement not covered" >			throw 'Probe needs to be an object and is ' + typeof probes + ' and should have an id';</span>
		}
